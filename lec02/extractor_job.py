...
def fetch_data_from_sales_API():
    try:
        ...
        return generate_error_json("Date is in a wrong format! Must be 'YYYY-MM-DD'!"), 400
    except KeyError:
        return generate_error_json("Both raw_dir and date parameters should be provided!"), 400
    ...
    try:
        ...
        return generate_error_json(f"Error while trying to save results: {exception}"), 500
